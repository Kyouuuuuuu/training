    ...
    return(
        <SafeAreaView>
            <ScrollView>
                ...
                <View>
                    <TouchableOpacity style={style.time}><Text style={style.timetext}>60 s</Text></TouchableOpacity>
                </View>
                <View>
                    <TouchableOpacity  style={style.backbutton}><Text style={style.back}>Next</Text></TouchableOpacity>
                </View>
